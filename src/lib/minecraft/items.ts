...
export const ITEMS: Record<ItemType, ItemDef> = {
  ...
  // Armor - Helmets
  [ItemType.LeatherHelmet]: { id: ItemType.LeatherHelmet, name: "Leather Cap", icon: "leather_helmet", maxStack: 1, armorType: "helmet", armorTier: "leather", defense: 1 },
  ...
  // Armor - Chestplates
  [ItemType.LeatherChestplate]: { id: ItemType.LeatherChestplate, name: "Leather Tunic", icon: "leather_chestplate", maxStack: 1, armorType: "chestplate", armorTier: "leather", defense: 3 },
  ...
  // Armor - Leggings
  [ItemType.LeatherLeggings]: { id: ItemType.LeatherLeggings, name: "Leather Pants", icon: "leather_leggings", maxStack: 1, armorType: "leggings", armorTier: "leather", defense: 2 },
